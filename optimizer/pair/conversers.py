...
from ..model_utils import get_template, get_template_orig
import ray
...
class AttackLM():
    ...
    def __init__(self, 
        ...
        self.template = get_template_orig(**model_kwargs, return_fschat_conv=True)
        ...
        for attempt in range(self.max_retries):
            ...
            for i, full_output in enumerate(outputs_list):
                ...
                if attack_dict is not None:
                    ...
                    convs_list[orig_index].update_last_message(full_output)
...
class TargetLM():
    ...
    def get_response(self, prompts_list, context_str=None):
        ...
        generate_function = self.model.batched_generate
...
def load_indiv_model(model_name_or_path, use_vllm=False, token=None, **model_kwargs):
    if 'gpt-' in model_name_or_path:
        ...
        if use_vllm:
            ...
            lm = HuggingFace(model_name_or_path=model_name_or_path, token=token, **model_kwargs)
